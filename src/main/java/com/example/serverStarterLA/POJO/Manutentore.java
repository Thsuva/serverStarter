...
/**
 * La classe Manutentore corrisponde in tutto e per tutto all'omonima tabella presente sul db, ed è munita di getter e setter
 * 
...
public class Manutentore {
	...
	public Manutentore(@NotNull String matricola, @NotNull String password, @NotNull String nome,
